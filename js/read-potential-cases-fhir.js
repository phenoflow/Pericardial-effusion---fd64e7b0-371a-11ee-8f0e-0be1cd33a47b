...
(async () => {
  ...
  await fs.writeFile("pericardial-effusion-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("pericardial-effusion-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
